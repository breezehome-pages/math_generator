...
// Improved long division display
    ...
    for (let i = 0; i < numQuestions; i++) {
        ...
        switch (operation) {
            case "addition":
                ...
                // Create space based on number of digits in the largest number and result
            ...
            case "subtraction":
                ...
                // Create space based on number of digits in the first number and result
